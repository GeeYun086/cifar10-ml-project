...
CIFAR-10 데이터셋을 기반으로 다양한 CNN 모델을 비교하고 학습 조건 및 데이터 처리 방식에 따른 성능 변화를 실험적으로 분석한 프로젝트입니다.
